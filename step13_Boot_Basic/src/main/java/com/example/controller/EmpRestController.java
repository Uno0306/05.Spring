...
public class EmpRestController {
	...
	public void insertDept( @RequestBody Emp param) {
...
//		emp = getEmpByEmpno(empno);
		if(empno == null) {
			...
			if(originEmp == null) {
				...
				Emp emp = new Emp();
				emp.setEmpno(empno);
				emp.setEname(param.getEname() == null ? originEmp.getEname() : param.getEname());
				emp.setJob(param.getJob() == null ? originEmp.getJob() : param.getJob());
				emp.setMgr(param.getMgr() == null ? originEmp.getMgr() : param.getMgr());
				emp.setHiredate(now);
				emp.setSal(param.getSal() == null ? originEmp.getSal() : param.getSal());
				emp.setComm(param.getComm() == null ? originEmp.getComm() : param.getComm());
				emp.setDept(param.getDept() == null ? originEmp.getDept() : param.getDept());
